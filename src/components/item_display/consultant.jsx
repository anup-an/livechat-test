...
const ConsultantDisplay = ({ webminar, accessToken, chatId, window }) => {
    ...
    return (
        ...
        >
            <div className={`border-l-2 border-blue-800 p-1 flex flex-row  justify-between space-x-10`}>
                ...
                <div>
                    <div className="text-sm">Rating: {webminar.ratings}</div>
                    <div className="text-sm">Experience: {webminar.yearsOfExperience} years</div>
                </div>
            </div>
