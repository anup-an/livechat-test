...
const Footer = ({ chatId, accessToken, openList }) => {
    const { sendWebminars, displaySelected, resetSelection, deleteWebminar, slideLeft, slideRight } = useContext(
        WebminarContext,
    );
    return (
        <div className="fixed left-0 right-0 bottom-0 w-full bg-white flex flex-col justify-between items-center">
            ...
            <div className="border rounded text-center text-xs bg-gray-100 flex flex-row justify-between items-center text-white w-full">
                ...
                >
                    <div className="flex items-center justify-center p-1 text-white">
                        <svg
                            className={`w-8 h-8 fill-current ${window === 'webinars' ? 'text-white' : 'text-gray-500'}`}
                            height="53.608"
                            width="60.049"
                ...
                >
                    <div className="flex items-center justify-center p-1">
                        <svg
                            className={`h-8 w-8 fill-current ${window === 'services' ? 'text-white' : 'text-gray-500'}`}
                            height="58.696"
                            width="55.798"
